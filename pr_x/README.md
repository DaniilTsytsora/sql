...
![Иллюстрация к проекту](https://github.com/DaniilTsytsora/sql/blob/main/sqlscreens/Screenshot_2.png)

**2. Воспроизведите ситуацию HOT-обновления на таблице с индексом по некоторым полям.**
![Иллюстрация к проекту](https://github.com/DaniilTsytsora/sql/blob/main/sqlscreens/Screenshot_3.png)

![Иллюстрация к проекту](https://github.com/DaniilTsytsora/sql/blob/main/sqlscreens/Screenshot_4.png)
...
![Иллюстрация к проекту](https://github.com/DaniilTsytsora/sql/blob/main/sqlscreens/Screenshot_5.png)

![Иллюстрация к проекту](https://github.com/DaniilTsytsora/sql/blob/main/sqlscreens/Screenshot_6.png)
...
![Иллюстрация к проекту](https://github.com/DaniilTsytsora/sql/blob/main/sqlscreens/Screenshot_7.png)

**Транзакция 1 с блокировкой для чтения строк по индексу:**
![Иллюстрация к проекту](https://github.com/DaniilTsytsora/sql/blob/main/sqlscreens/Screenshot_8.png)

**Транзакция 2, которая пытается изменить те же строки:**
![Иллюстрация к проекту](https://github.com/DaniilTsytsora/sql/blob/main/sqlscreens/Screenshot_9.png)
...
![Иллюстрация к проекту](https://github.com/DaniilTsytsora/sql/blob/main/sqlscreens/Screenshot_10.png)

**Транзакция 2**
![Иллюстрация к проекту](https://github.com/DaniilTsytsora/sql/blob/main/sqlscreens/Screenshot_11.png)

# Pr 12

**1. Влияние подготовки на выполнение долгого оператора. Вычислите среднюю стоимость одного билета; посчитайте среднее время выполнения этого запроса. Подготовьте оператор для этого запроса; снова посчитайте среднее время выполнения. Во сколько раз ускорилось выполнение?**

![Иллюстрация к проекту](https://github.com/DaniilTsytsora/sql/blob/main/sqlcreens2/Screenshot_2.png)

**2. Влияние подготовки на выполнение коротких операторов. Многократно запросите данные о бронировании с номером 0824C5; посчитайте среднее время выполнения. Подготовьте оператор для этого запроса; снова посчитайте среднее время выполнения. Во сколько раз ускорилось выполнение в этом случае?**

![Иллюстрация к проекту](https://github.com/DaniilTsytsora/sql/blob/main/sqlcreens2/Screenshot_4.png)

**3. Убедитесь, что запрос, вычисляющий среднюю стоимость перелета, выполняется параллельно.**
![Иллюстрация к проекту](https://github.com/DaniilTsytsora/sql/blob/main/sqlcreens2/Screenshot_5.png)

**4. Проверьте, как выполняется тот же запрос, если чтение из таблицы перелетов оформлено как общее табличное выражение.**
![Иллюстрация к проекту](https://github.com/DaniilTsytsora/sql/blob/main/sqlcreens2/Screenshot_6.png)

**5. Напишите запрос, выбирающий максимальную сумму бронирования. Проверьте план выполнения. Какой метод доступа выбрал планировщик? Эффективен ли такой доступ? – не эффективен**
